    ...
    return (
      <div className="w-full h-screen font-poppins  px-4 pt-8 bg-blue-600 text-white flex flex-col">
        <div className="flex justify-start mb-16">
          ...
          <div className="font-semibold text-2xl font-lufga mt-2 ml-3">Omnisupport</div>
        </div>
          ...
          >
            ...
            >
                ...
                className={`transition duration-300 ${
                    pathname === "/" ? "stroke-blue-600" : "group-hover:stroke-blue-600"
                  }`}                />
            </svg>
            ...
            <div className=" text-black rounded-lg mt-2 py-2 ml-8  w-44">
                <Link href="/in-app" className="block text-white font-medium hover:text-blue-600 px-4 py-2 rounded-md hover:bg-gray-200">
                In-app
                </Link>
                <Link href="/email" className="block px-4 py-2 text-white font-medium hover:text-blue-600 rounded-md hover:bg-gray-200">
                Email
                </Link>
                <Link href="/whatsapp" className="block px-4 py-2 text-white font-medium hover:text-blue-600 rounded-md hover:bg-gray-200">
                WhatsApp
                </Link>
                <Link href="/app-store" className="block px-4 py-2 text-white font-medium hover:text-blue-600 rounded-md hover:bg-gray-200">
                App Store
                </Link>
                <Link href="/play-store" className="block px-4 py-2 text-white font-medium hover:text-blue-600 rounded-md hover:bg-gray-200">
                Play Store 
                </Link>
            </div>
            )}
